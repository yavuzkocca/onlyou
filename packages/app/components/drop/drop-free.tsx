...
export const DropFree = () => {
  ...
  // console.log(
  //   `UserFreeDrop=${JSON.stringify(user.user.data.data.profile.username)}`
  // );
        ...
        <View>
                  ...
                  <DropFileZone onChange={handleFileChange}>
                    <View tw="z-1">
                      <Pressable
                        // onPress={() => {
                        //   openFileSelector();
                        //   handleFileChange(filesContent[0].content);
          ...
          <View tw="mt-8">
            ...
            {state.editon?.data.transactionHash ? (
              <View tw="mt-4">
                <PolygonScanButton
                  transactionHash={state.editon?.data.transactionHash}
                />
              </View>
            ) : null}
