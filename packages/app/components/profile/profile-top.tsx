...
import { getFullSizeCover, getNextRefillClaim } from "app/utilities";
...
export const ProfileTop = ({
  ...
  console.log(`PROFILEDATAAAAAAA=${JSON.stringify(profileData)}`);
  const name = profileData?.data.profile.name;
  ...
  const profileId = profileData?.data?.profile?._id;
  console.log(`ProfileData=${JSON.stringify(profileData)}`);
  // console.log(profileData?.data.followers_count);
          ...
          <>
            {profileData?.data.profile.cover_url && (
              ...
              >
                <Image
                  source={{
                    uri: getFullSizeCover(profileData?.data.profile.cover_url),
                  }}
                  alt="Cover image"
                  resizeMode="cover"
                  width={coverWidth}
              ...
              >
                {profileData && (
                  ...
                  >
                    <Image
                      source={{
                        uri: profileData.data.profile.img_url,
                      }}
                      ...
                      alt={profileData?.data.profile.name}
                    />
                  </LightBox>
                )}
              </Skeleton>
        ...
        <View tw="px-2 py-3">
          {isLoading ? (
            ...
            <View tw="flex-row items-start justify-between">
              ...
              <ProfileSocial profile={profileData} />
            </View>
          )}
