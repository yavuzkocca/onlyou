...
function NFTDropdown({
  ...
  const { shareNFT, shareNFTOnTwitter, showPrivImage } = useShareNFT();
  ...
  const isSelf = user?.data?.profile?._id === nft?.creator_id;
  console.log(`THENFT ${nft?.has_priv_image}`);
  console.log(isSelf);
  // console.log("USERRRR" + JSON.stringify(user));

  const isFollowingUser = useMemo(
    () => isFollowing(nft?.creator_id),
